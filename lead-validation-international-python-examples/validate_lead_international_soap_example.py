...
sys.path.insert(0, os.path.abspath("../lead-validation-international-python/SOAP"))

from validate_lead_international_soap import ValidateLeadInternational

def validate_lead_international_soap_sdk_go(license_key: str, is_live: bool) -> None:
    print("\n-----------------------------------------------------------------------")
    print("LeadValidationInternational - ValidateLeadInternationalInput - SOAP SDK")
    print("-----------------------------------------------------------------------")
