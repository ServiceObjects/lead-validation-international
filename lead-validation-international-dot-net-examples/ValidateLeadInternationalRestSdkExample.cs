...
{
    public static class ValidateLeadInternationalRestSdkExample
    {
        public static async Task Go(string licenseKey, bool isLive)
        {
            Console.WriteLine("\r\n-----------------------------------------------------------------------");
            Console.WriteLine("LeadValidationInternational - ValidateLeadInternationalInput - REST SDK");
            Console.WriteLine("-----------------------------------------------------------------------");

            ValidateLeadInternational.ValidateLeadInternationalInput input = new(
                FullName: "Tim Cook",
                Salutation: "",
                FirstName: "Tim",
                LastName: "Cook",
            ...
            Console.WriteLine($"Full Name      : {input.FullName}");
            Console.WriteLine($"Salutation     : {input.Salutation}");
            Console.WriteLine($"First Name     : {input.FirstName}");
            Console.WriteLine($"Last Name      : {input.LastName}");
            Console.WriteLine($"Business Name  : {input.BusinessName}");
            Console.WriteLine($"Business Domain: {input.BusinessDomain}");
            Console.WriteLine($"Business EIN   : {input.BusinessEIN}");
            Console.WriteLine($"Address 1      : {input.Address1}");
            Console.WriteLine($"Address 2      : {input.Address2}");
            Console.WriteLine($"Address 3      : {input.Address3}");
            Console.WriteLine($"Address 4      : {input.Address4}");
            Console.WriteLine($"Address 5      : {input.Address5}");
            Console.WriteLine($"Locality       : {input.Locality}");
            Console.WriteLine($"Admin Area     : {input.AdminArea}");
            Console.WriteLine($"Postal Code    : {input.PostalCode}");
            Console.WriteLine($"Country        : {input.Country}");
            Console.WriteLine($"Phone 1        : {input.Phone1}");
            Console.WriteLine($"Phone 2        : {input.Phone2}");
            Console.WriteLine($"Email          : {input.Email}");
            Console.WriteLine($"IP Address     : {input.IPAddress}");
            Console.WriteLine($"Gender         : {input.Gender}");
            Console.WriteLine($"Date of Birth  : {input.DateOfBirth}");
            Console.WriteLine($"UTC Capture    : {input.UTCCaptureTime}");
            Console.WriteLine($"Output Language: {input.OutputLanguage}");
            Console.WriteLine($"Test Type      : {input.TestType}");
